...
const ResumeHero = () => {
  return (
    <div className="text-center mb-24 mt-0">
      <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-8">
        <span className="relative flex h-2 w-2">
          <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-cyan-400 opacity-75"></span>
          <span className="relative inline-flex rounded-full h-2 w-2 bg-cyan-500"></span>
        </span>
        <span className="text-[12px] text-cyan-500 font-mono  ">System Status: Online</span>
      </div>
      
      <h1 className="text-5xl md:text-8xl font-black text-white   italic leading-none">
        ATS <span className="text-cyan-500">CRACKER.</span>
      </h1>
      
      <div className="mt-8 flex flex-col md:flex-row items-center justify-center gap-6">
        <p className="max-w-md text-gray-500 text-s leading-loose  text-center md:text-left">
        ...
        <p className="max-w-md text-gray-500 text-s leading-loose  text-center md:text-right">
