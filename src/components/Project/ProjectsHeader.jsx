  ...
  return (
    <div className="max-w-7xl mx-auto mb-16 flex flex-col md:flex-row md:items-end justify-between gap-6">
      <div className="flex-1">
        <span className="text-cyan-500 font-mono text-m ">
          Marketplace
        </span>
      ...
      <button 
        ...
        className="group flex items-center gap-3 bg-cyan-500 text-black px-6 py-4 rounded-2xl font-black  text-[14px] transition-all hover:bg-cyan-400 active:scale-95"
      >
        <ShoppingBag size={18} />
