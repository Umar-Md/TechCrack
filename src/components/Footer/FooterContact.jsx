...
const FooterContact = () => (
  <div>
    <h4 className="text-white font-bold   text-[10px] mb-6 opacity-50">Connect</h4>
    <div className="space-y-6">
      <div className="flex items-start gap-3">
        <Mail className="text-cyan-500 shrink-0" size={18} />
        <div className="text-sm">
          <p className="text-gray-500  text-[9px] font-bold ">Direct Email</p>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="text-sm">
          <p className="text-gray-500  text-[9px] font-bold ">Social Media</p>
