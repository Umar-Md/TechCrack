...
export const TechBadge = ({ name }) => (
  <span className="px-3 py-1 text-[12px] font-bold  bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 rounded-full">
    {name}
  </span>
);
...
export const GlassSection = ({ children, title }) => (
  ...
  >
    ...
    {title && <h3 className="text-2xl font-black text-white mb-6 ">{title}</h3>}
    {children}
  </motion.div>
);